...
<div class="email" style="width: 600px; margin: auto;">
	<div class="header" style="background: #212121; border-bottom: 4px solid #f55347; padding: 40px;">
		<a href="<?= $url ?>"><div style="background: url(<?= $url ?>/image/footer-EduHot.png); width: 241px; height: 47px; display: inline-block;"></div></a>
	...
	<div class="footer" style="background: #212121; border-top: 4px solid #f55347; padding: 40px;">
		<div style=" display: inline-block; font-family: Arial; color: #f8f8f8; font-size: 15px; font-weight: 400; text-align: left; width: 170px;">
			...
			<div>
				<a href="" style="display: inline-block;   margin: 5px 5px 5px 0;"><div style="  background: url(<?= $url ?>/image/icon/Layer47_cr1.png) no-repeat;   width: 35px;   height: 35px;"></div></a>
				<a href="" style="display: inline-block;   margin: 5px 5px;"><div style="  background: url(<?= $url ?>/image/icon/Layer47_cr2.png) no-repeat;   width: 35px;   height: 35px;"></div></a>
				<a href="" style="display: inline-block;   margin: 5px 5px;"><div style="  background: url(<?= $url ?>/image/icon/Layer47_cr3.png) no-repeat;   width: 35px;   height: 35px;"></div></a>
			</div>
		</div>
